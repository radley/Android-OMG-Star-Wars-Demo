...
import dev.radley.omgstarwars.ui.search.category.adapters.SpeciesAdapter;
...
import dev.radley.omgstarwars.ui.search.category.viewmodels.SpeciesViewModel;
...
public class SpeciesFragment extends BaseCategoryFragment {
    ...
    public static SpeciesFragment newInstance() {
        SpeciesFragment myFragment = new SpeciesFragment();
        return myFragment;
    }

    public static SpeciesFragment newInstance(String query) {
        SpeciesFragment myFragment = new SpeciesFragment();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mRecyclerView.addOnItemTouchListener(new RecyclerTouchListener(getContext()) {
            ...
            public void onItemSelected(RecyclerView.ViewHolder holder, int position) {
                startActivity(DetailExtras.getIntent(getActivity(), (Species) mViewModel.getItem(position)));
            }
        });
